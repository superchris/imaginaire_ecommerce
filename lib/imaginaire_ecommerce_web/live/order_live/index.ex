defmodule ImaginaireEcommerceWeb.OrderLive.Index do
  use ImaginaireEcommerceWeb, :live_view
  ...
  @impl true
  def handle_info({ImaginaireEcommerceWeb.OrderLive.FormComponent, {:saved, order}}, socket) do
